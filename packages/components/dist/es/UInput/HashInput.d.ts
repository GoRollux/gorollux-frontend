...
export declare type UHashInputOnSearch = (value: string, category: string) => Promise<{
    label: string;
    value: string | number;
}[]>;
...
export declare const UHashInputSymbol: InjectionKey<UHashInputState>;
export declare type UHashInputPropsType = SelectProps;
declare const UHashInput: import("vue").DefineComponent<{
    category: {
        type: PropType<"comerSkill" | "startup" | "bounty">;
        required: true;
    };
...
export declare const UHashInputProvider: import("vue").DefineComponent<{
    onSearch: {
        type: PropType<UHashInputOnSearch>;
        required: true;
    };
