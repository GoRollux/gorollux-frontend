...
import './index.css';
export declare type UPaginationPropsType = PaginationProps;
declare const UPagination: import("vue").DefineComponent<{}, () => JSX.Element, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").DefineComponent<{
    ...
    readonly pageSizes: {
        readonly type: import("vue").PropType<(number | import("naive-ui").PaginationSizeOption)[]>;
        readonly default: () => number[];
    };
    readonly showQuickJumper: BooleanConstructor;
    readonly size: {
        readonly type: import("vue").PropType<import("naive-ui/es/pagination/src/interface").Size>;
    ...
    readonly prev: import("vue").PropType<import("naive-ui/es/pagination/src/interface").RenderPrefix>;
    readonly next: import("vue").PropType<import("naive-ui/es/pagination/src/interface").RenderPrefix>;
    readonly prefix: import("vue").PropType<import("naive-ui/es/pagination/src/interface").RenderPrefix>;
    readonly suffix: import("vue").PropType<import("naive-ui/es/pagination/src/interface").RenderPrefix>;
    readonly label: import("vue").PropType<import("naive-ui").PaginationRenderLabel>;
    readonly displayOrder: {
        readonly type: import("vue").PropType<("pages" | "size-picker" | "quick-jumper")[]>;
        readonly default: readonly ["pages", "size-picker", "quick-jumper"];
    };
    readonly 'onUpdate:page': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void>>;
    readonly onUpdatePage: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void>>;
    readonly 'onUpdate:pageSize': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void>>;
    readonly onUpdatePageSize: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void>>;
    readonly onPageSizeChange: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void>>;
    readonly onChange: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void>>;
    readonly theme: import("vue").PropType<import("naive-ui/es/_mixins").Theme<"Pagination", {
        buttonColor: string;
    ...
    readonly themeOverrides: import("vue").PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Pagination", {
        buttonColor: string;
        buttonColorHover: string;
        buttonColorPressed: string;
        buttonBorder: string;
    ...
    readonly builtinThemeOverrides: import("vue").PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Pagination", {
        buttonColor: string;
        buttonColorHover: string;
        buttonColorPressed: string;
        buttonBorder: string;
    ...
    pageItems: import("vue").ComputedRef<import("naive-ui/es/pagination/src/utils").PageItem[]>;
    mergedItemCount: import("vue").ComputedRef<number>;
    jumperValue: import("vue").Ref<string>;
    pageSizeOptions: import("vue").ComputedRef<import("naive-ui").PaginationSizeOption[]>;
    mergedPageSize: import("vue").ComputedRef<number>;
    inputSize: import("vue").ComputedRef<import("naive-ui/es/input/src/interface").Size>;
    selectSize: import("vue").ComputedRef<import("naive-ui/es/select/src/interface").Size>;
    ...
    handlePageItemClick: (pageItem: import("naive-ui/es/pagination/src/utils").PageItem) => void;
    ...
    readonly size: import("naive-ui/es/pagination/src/interface").Size;
    readonly disabled: boolean;
    readonly simple: boolean;
    readonly defaultPage: number;
    readonly defaultPageCount: number;
    readonly showSizePicker: boolean;
    readonly pageSizes: (number | import("naive-ui").PaginationSizeOption)[];
