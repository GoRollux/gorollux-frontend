...
export declare type USelectPropsType = SelectProps;
export declare type USelectOption = SelectOption;
declare const USelect: import("vue").DefineComponent<{}, () => JSX.Element, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").DefineComponent<{
    readonly to: {
    ...
    handleToggle: (tmNode: import("treemate").TreeNode<SelectOption, SelectOption, SelectOption>) => void;
