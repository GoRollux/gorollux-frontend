...
export declare type USwitchPropsType = SwitchProps;
declare const USwitch: import("vue").DefineComponent<{}, () => JSX.Element, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").DefineComponent<{
    readonly size: {
        readonly type: import("vue").PropType<"small" | "medium" | "large">;
        readonly default: "medium";
    };
    readonly value: {
        readonly type: import("vue").PropType<string | number | boolean | undefined>;
    ...
    readonly 'onUpdate:value': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/switch/src/interface").OnUpdateValue>>;
    readonly onUpdateValue: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/switch/src/interface").OnUpdateValue>>;
    ...
    readonly railStyle: import("vue").PropType<(params: {
        focused: boolean;
        checked: boolean;
    ...
    readonly onChange: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/switch/src/interface").OnUpdateValue> | undefined>;
    readonly theme: import("vue").PropType<import("naive-ui/es/_mixins").Theme<"Switch", {
        iconColor: string;
        textColor: string;
        loadingColor: string;
    ...
    readonly themeOverrides: import("vue").PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Switch", {
        iconColor: string;
        textColor: string;
        loadingColor: string;
        opacityDisabled: string;
    ...
    readonly builtinThemeOverrides: import("vue").PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Switch", {
        iconColor: string;
        textColor: string;
        loadingColor: string;
        opacityDisabled: string;
    ...
    mergedRailStyle: import("vue").ComputedRef<string | import("vue").CSSProperties | undefined>;
